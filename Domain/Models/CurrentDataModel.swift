...
struct CurrentDataModel: Codable {
    ...
    let symbol: String
    let name: String
    let currentDescription: [String: String]
...
struct MarketDataModel: Codable {
    ...
    let pricechangepercentagelyInCurrency: [String: Double]
    ...
    enum Codingkeys: String, CodingKey {
        ...
        case fullyDilutedValuation = "fully_diluted _valuation"
        ...
        case atl
        case atlChangePercentage = "atl _change _percentage"
        case atlDate = "atl date"
